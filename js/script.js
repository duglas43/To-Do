...
document.addEventListener("DOMContentLoaded",()=>{
    ...
    const DOM__project__list=document.querySelector(".project-list"), //ul
          project__item__btn__list=document.querySelectorAll(".project-item__btn");
    // Input
    ...
    const cancel__project__btn=document.querySelector(".add-project__modal-cancel");
    ...
    add__project__add.onclick=()=>{
        let valid=[...document.querySelectorAll(".project-item__btn-title")].every(n=>n.textContent!=project__input.value);
        if(valid){
            ...
            console.log("Повторение мать учения")
        }
    }
